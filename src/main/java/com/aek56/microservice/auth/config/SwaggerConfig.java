...
public class SwaggerConfig {
	...
	public Docket platformApi() {
		/*return new Docket(DocumentationType.SWAGGER_2)
				...
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.aek56.microservice.auth.apis"))
		...
		return new Docket(DocumentationType.SWAGGER_2).apiInfo(apiInfo()).groupName("ebey")
				...
				.select().apis(RequestHandlerSelectors.basePackage("com.aek56.microservice.auth.apis"))
