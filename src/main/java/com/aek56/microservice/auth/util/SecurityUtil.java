...
import com.aek56.microservice.auth.util.security.BASE64Encoder;
import com.aek56.microservice.auth.util.security.coder.DESCoder;
import com.aek56.microservice.auth.util.security.coder.HmacCoder;
import com.aek56.microservice.auth.util.security.coder.MDCoder;
import com.aek56.microservice.auth.util.security.coder.RSACoder;
import com.aek56.microservice.auth.util.security.coder.SHACoder;
...
public final class SecurityUtil {
	...
	public static void main(String[] args) throws Exception {
		...
		String desc = encryptDes("1111111111");
		System.out.println(desc);
		System.out.println(decryptDes(desc));
	}
}
